		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#invoiceapproval_S4Hana-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoiceapproval_S4Hana-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoiceapproval_S4Hana",
									"url": sap.ui.require.toUrl("invoiceapproval_S4Hana")
								}
							}
						}
					}
